...
RIP: Instruction Pointer Register (x86-64) \
...
**[ELF (GOT/PLT) {ChatGPT}](./_elf1.md)**

**[Shared Library {en:wiki}](https://en.wikipedia.org/wiki/Shared_library)**

**[Executable and Linkable Format {en:wiki}](https://en.wikipedia.org/wiki/Executable_and_Linkable_Format)**

**[In-depth: ELF - The Extensible & Linkable Format {YTB}](https://www.youtube.com/watch?v=nC1U1LJQL8o)**
...
**[Address space layout randomisation {en:wiki}](https://en.wikipedia.org/wiki/Address_space_layout_randomization)**

...
[Shared Library {wiki}](https://en.wikipedia.org/wiki/Shared_library)

[Executable and Linkable Format {wiki}](https://en.wikipedia.org/wiki/Executable_and_Linkable_Format)
...
[Address space layout randomisation {wiki}](https://en.wikipedia.org/wiki/Address_space_layout_randomization)
